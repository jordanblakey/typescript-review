...
document.write(
  superheroes[0].realName + ' is ' + superheroes[0].superName + '.<br>'
)
...
document.write(
  'TL;DR, `let` scopes a variable to a code block. var scopes it to the containing function. const scopes like var, but cannot be unassigned.<br><br> '
)
